...
This linear model is least successful at predicting `life_expectancy` in Union County, PA and Noble County, OH. The fitted values are 76.82 and 78.80 years of age respectively, while actual values are 82.37 and 81.17 years. Residuals were 5.55 and 5.37 each.
...
What differences in life expectancy are observed between progressively higher-income categories in the `r nrow(chr_2020)` counties of Indiana, Michigan, Ohio, and Pennsylvania?
...
The normal Q-Q plots and boxplots show reasonable normality for the residuals in each category, though the highest and lowest income categories seem notably less normal than the other two, with heavier tails and less of a smooth curve. The model predicted Cuyahoga County's life expectancy to be `r 75.82+1.09`, while the actual life expectancy was `r round(cuyahoga$life_expectancy,2)`. The two counties where the model was least successful in predicting life expectancy were Centre County in Pennsylvania and Fayette County in Indiana.
...
The linear model is least successful at predicting `life_expectancy` in Scott County, Indiana and Delaware County, Ohio. The fitted values are 77.00 and 77.11 years of age respectively, while their actual values are 71.59 and 82.44 years. Residuals were -5.41 and 5.33 each.
