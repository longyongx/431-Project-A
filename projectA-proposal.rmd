...
```{r, message = FALSE}
chr_2020 <- chr_2020 %>%
    mutate(food_binary = case_when(is.na(food_environment_index) ~ "N/A",
                   food_environment_index < median(food_environment_index, na.rm = TRUE) ~ "low",
                   TRUE ~ "high"),
...
uninsured_adults | (v003) Percentage of uninsured Adults
some_college | (v069) Percentage of Adults 25-44 with post-secondary education
median_household_income | (v063) Median Household Income
food_environment_index | (v133) Food Environment Index
food_binary | 2 levels: low = food_environment_index below median, or high
